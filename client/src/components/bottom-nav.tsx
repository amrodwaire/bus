...
export function BottomNav() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 bg-card border-t border-card-border z-50 pb-[env(safe-area-inset-bottom)]">
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            className={`flex flex-col items-center justify-center gap-1 px-4 py-2 rounded-md transition-colors min-w-[64px] ${isActive
                                    ? "text-primary"
