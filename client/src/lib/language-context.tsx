...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    liveLocation: "الموقع المباشر للباص",
    gpsActive: "نشط ✓",
    gpsDenied: "مرفوض",
    gpsWaiting: "في الانتظار...",
    ...
    autoCancelTitle: "تم إلغاء الحجز تلقائياً",
    autoCancelDesc: "ابتعدت أكثر من 100 متر عن نقطة الالتقاط. يمكنك حجز مقعد جديد.",
  ...
  en: {
    ...
    autoCancelTitle: "Reservation Auto-Cancelled",
    autoCancelDesc: "You moved more than 100m from your pickup point. You can book a new seat.",
