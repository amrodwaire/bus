...
const translations: Record<Language, Record<string, string>> = {
    ar: {
        ...
        busVisibility: "ظهور الباص",
        visible: "ظاهر",
        hidden: "مخفي",
        myLocation: "موقعي",
        routeNamePlaceholder: "مثال: عمان - الزرقاء",
        routeNameEnPlaceholder: "Example: Amman - Zarqa",
        ...
        fromPointTooFarDesc: "يجب أن تحدد نقطة الانطلاق على بعد 500 متر منك كحد أقصى — اضغط على موقعك الحالي أو قريباً منه",
        ...
        roadClear: "الطريق سالك",
        roadClearDesc: "الطريق مفتوح بين نقطة الانطلاق والوجهة",
        roadDetour: "تحويلة في الطريق",
        roadDetourDesc: "يبدو أن الطريق المباشر مسكر — المسار الحالي أطول بـ {ratio}x من المسافة المباشرة",
        roadBlocked: "الطريق مسكر",
        roadBlockedDesc: "ما في طريق متاح بين النقطتين — الطريق ممكن يكون مسكر أو مقطوع",
        roadStatus: "حالة الطريق",
        checkingRoad: "جاري فحص الطريق...",
        ...
        kmh: "كم/س",
        eta: "الوصول خلال",
        busApproaching: "الباص يقترب!",
        busApproachingDesc: "الباص على بعد أقل من 500 متر منك — استعد!",
        walkToStop: "امش إلى المحطة",
        walkingRoute: "مسار المشي",
        walkMin: "دقيقة مشي",
        setRouteToSeeBuses: "حدد مسارك لعرض الباصات",
        setRouteToSeeBusesDesc: "اضغط على زر 'حدد المسار' أعلاه لتحديد نقطة الانطلاق والوجهة",
        citizenLocation: "موقع الراكب",
        filterBuses: "فلتر الباصات",
        allBuses: "كل الباصات",
        nearbyOnly: "القريبة فقط",
        onRouteOnly: "على المسار فقط",
    },
    en: {
        appName: "Coster",
        ...
        routeNamePlaceholder: "Example: Amman - Zarqa",
        routeNameEnPlaceholder: "Example: Amman - Zarqa",
        ...
        fromPointTooFarDesc: "Your departure point must be within 500 meters of your current GPS location — tap near where you are standing",
        ...
        roadClear: "Road is clear",
        roadClearDesc: "The road is open between your departure and destination",
        roadDetour: "Detour detected",
        roadDetourDesc: "The direct road appears blocked — the current route is {ratio}x longer than the direct distance",
        roadBlocked: "Road is blocked",
        roadBlockedDesc: "No route available between the two points — the road may be blocked or closed",
        roadStatus: "Road Status",
        checkingRoad: "Checking road...",
        ...
        kmh: "km/h",
        eta: "ETA",
        busApproaching: "Bus is approaching!",
        busApproachingDesc: "The bus is less than 500 meters away — get ready!",
        walkToStop: "Walk to stop",
        walkingRoute: "Walking Route",
        walkMin: "min walk",
        setRouteToSeeBuses: "Set your route to see buses",
        setRouteToSeeBusesDesc: "Tap the 'Set Route' button above to set your departure and destination",
        citizenLocation: "Passenger Location",
        filterBuses: "Filter Buses",
        allBuses: "All Buses",
        nearbyOnly: "Nearby Only",
        onRouteOnly: "On Route Only",
    },
};
