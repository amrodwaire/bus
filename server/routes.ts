...
export interface IStorage {
    // تم توحيد الأنواع لتكون string لإنهاء إيرور TS2769
...
export class MemStorage implements IStorage {
    ...
    private seedData() {
        ...
        this.users.set(dId, { id: dId, username: "driver1", password: "123456", fullName: "أحمد السائق", role: "driver" } as any);
        const uId = "user-123";
        this.users.set(uId, { id: uId, username: "user1", password: "123456", fullName: "سارة المواطنة", role: "citizen" } as any);
    }
    ...
    // إصلاح الإيرور اللي في الصورة image_aac184
    ...
    async getNextPriority(busId: string) {
        const list = await this.getReservationsByBus(busId);
