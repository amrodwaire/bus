...
async function seedIfEmpty() {
    try {
        ...
        const driverResult = await db.execute(sql`
            ...
            VALUES ('driver1', '123456', 'أحمد محمد السائق', '0791234567', 'driver', '9876543210', 'DRV-001')
            RETURNING id
        `);
        ...
        await db.execute(sql`
            ...
            VALUES ('user1', '123456', 'محمد علي المواطن', '0799876543', 'citizen', '1234567890')
        `);
